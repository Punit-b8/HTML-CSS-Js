//for the weather api
const apiKey = "21936a31b61333af6993b3ad3c3f8d8d";
...
async function checkWeather(city) {
  ...
  var data = await response.json();//decleared for getting the data from the api
 ...
 //for the weather icon respective to the weather
